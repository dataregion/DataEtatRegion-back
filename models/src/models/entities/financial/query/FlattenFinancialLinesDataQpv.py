...
class FlattenFinancialLinesDataQPV(_PersistenceBaseModelInstance()):
    """
...
class EnrichedFlattenFinancialLinesDataQPV(FlattenFinancialLinesDataQPV):
    """
    ...
    tags: Mapped[List[Tags]] = relationship(
        ...
        primaryjoin=(
            "or_("
            "and_(EnrichedFlattenFinancialLinesDataQPV.id==TagAssociation.financial_ae, EnrichedFlattenFinancialLinesDataQPV.source=='FINANCIAL_DATA_AE'),"
            "and_(EnrichedFlattenFinancialLinesDataQPV.id==TagAssociation.financial_cp, EnrichedFlattenFinancialLinesDataQPV.source=='FINANCIAL_DATA_CP'),"
            "and_(EnrichedFlattenFinancialLinesDataQPV.id==TagAssociation.ademe, EnrichedFlattenFinancialLinesDataQPV.source=='ADEME'),"
            ")"
        ),
        viewonly=True,
    )
