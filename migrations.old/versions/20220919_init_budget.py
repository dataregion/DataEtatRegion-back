...
def upgrade():
    ...
    op.create_table(
        "ref_localisation_interministerielle",
        sa.Column("id", sa.Integer(), nullable=False),
        sa.Column("code", sa.String(), nullable=False),
        sa.Column("label", sa.String(), nullable=True),
        sa.Column("description", sa.Text(), nullable=True),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["centre_couts"],
            ["ref_centre_couts.code"],
        ),
        sa.ForeignKeyConstraint(
            ["compte_general"],
            ["ref_compte_general.code"],
        ),
        sa.ForeignKeyConstraint(
            ["domaine_fonctionnel"],
            ["ref_domaine_fonctionnel.code"],
        ),
        sa.ForeignKeyConstraint(
            ["fournisseur_titulaire"],
            ["ref_fournisseur_titulaire.code"],
        ),
        sa.ForeignKeyConstraint(
            ["groupe_marchandise"],
            ["ref_groupe_marchandise.code"],
        ),
        sa.ForeignKeyConstraint(
        ...
        sa.ForeignKeyConstraint(
            ["programme"],
            ["ref_code_programme.code"],
        ),
        sa.ForeignKeyConstraint(
            ["referentiel_programmation"],
            ["ref_programmation.code"],
        ),
        sa.ForeignKeyConstraint(
            ["siret"],
            ["ref_siret.code"],
