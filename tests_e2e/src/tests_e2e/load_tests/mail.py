from .configuration import mail_enabled, mail_host, mail_from, mail_login, mail_password, mail_port, mail_to
...
class SendEmail:
    ...
    def content(self):
        return "Les tests de charge se sont terminés avec succès." if self.ctx.success else "Les tests de charge ont échoué. Veuillez vérifier les logs."
