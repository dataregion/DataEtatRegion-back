...
class APIResponse:
    ...
    def to_json_response(self) -> JSONResponse:
        ...
        return JSONResponse(
            ...
            content=self.to_clean_dict() if self.code != HTTPStatus.NO_CONTENT else None
        )
...
class APISuccess(APIResponse, Generic[T]):
    ...
    def __init__(
        ...
        if current_page is not None and has_next is not None:
            self.pagination = PaginationMeta(current_page=current_page, has_next=has_next).to_dict()
