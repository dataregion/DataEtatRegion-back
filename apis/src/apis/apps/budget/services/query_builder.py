...
class SourcesQueryBuilder(V3QueryBuilder[FinancialLines]):
    ...
    def source_region_in(self, source_region: list[str] | None, can_be_null: bool = True):
        ...
        self.where_field_in(FinancialLines.source_region, source_region, can_be_null=can_be_null)
        return self
    ...
    def par_identifiant_technique(self, source: DataType, id: int):
        ...
        self._query = self._query.where(FinancialLines.source == str(source.value), FinancialLines.id == id)
        return self
...
class FinancialLineQueryBuilder(SourcesQueryBuilder):
    ...
    def niveau_code_qpv_in(self, ref_qpv: int | None, code_qpv: list | None, source_region: str):
