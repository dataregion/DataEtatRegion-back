...
api = Namespace(name="task", path="/", description="Gestion des task asynchrone")
...
class SiretRef(Resource):
    ...
    def post(self):
        ...
        return jsonify({"status": f"Demande de mise à jour des siret faite. (Tâche asynchrone id {task.id})"})
