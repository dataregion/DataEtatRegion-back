...
def test_import_new_line_cp_nation(database, session):
    # GIVEN
    data = '{"programme":"0354","domaine_fonctionnel":"0354-02","centre_couts":"ADCSDAT076","referentiel_programmation":"035301010301","n_ej":"2104583353null","n_poste_ej":"1","n_dp":"100379604","date_base_dp":"11\\/12\\/2024","date_derniere_operation_dp":"13\\/12\\/2024","fournisseur_paye":"1000972118","fournisseur_paye_label":"AGENCE NATIONALE DES TITRES","siret":"13000326200024","compte_code":"6541100000","compte_budgetaire":"64","groupe_marchandise":"12.01.01","contrat_etat_region":"","localisation_interministerielle":"N1175","montant":"100,18","exercice_comptable":"2024","n_poste_dp":"2","programme_doublon":"0354","tranche_fonctionnelle":"","fonds":"","projet_analytique":"","societe":"CSPE","type_piece":"RE","data_source":"NATION","source_region":"00"}'
    ...
    assert cp.n_ej == "2104583353null"
    assert cp.programme == "354"
    assert cp.societe == "CSPE"

    delete_references(session)


def test_import_new_line_cp_nation_source_region_null(database, session):
    # GIVEN
    data = '{"programme":"0354","domaine_fonctionnel":"0354-02","centre_couts":"ADCSDAT076","referentiel_programmation":"035301010301","n_ej":"2104583353","n_poste_ej":"1","n_dp":"100379604","date_base_dp":"","date_derniere_operation_dp":"13\\/12\\/2024","fournisseur_paye":"1000972118","fournisseur_paye_label":"AGENCE NATIONALE DES TITRES","siret":"13000326200024","compte_code":"6541100000","compte_budgetaire":"64","groupe_marchandise":"12.01.01","contrat_etat_region":"","localisation_interministerielle":"N1175","montant":"100,18","exercice_comptable":"2024","n_poste_dp":"2","programme_doublon":"0354","tranche_fonctionnelle":"","fonds":"","projet_analytique":"","societe":"DILA","type_piece":"RE","data_source":"NATION","source_region":null}'
    ...
    assert cp.date_base_dp is None
