...
@pytest.fixture
def fernet(fernet_key):  # noqa: F811
...
def test_find_enabled_by_uuid_utilisateur(fernet, init_tokens):  # noqa: F811
...
def test_find_by_uuid_utilisateur_and_token_id(init_tokens, fernet):  # noqa: F811
...
def test_create(init_tokens, fernet):  # noqa: F811
...
def test_create_existing(init_tokens, fernet):  # noqa: F811
    uuid_utilisateur = "USER3"
...
def test_update(init_tokens, fernet):  # noqa: F811
...
def test_delete(init_tokens):  # noqa: F811
