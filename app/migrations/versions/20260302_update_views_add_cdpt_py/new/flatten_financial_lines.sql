-- public."_flatten_financial_lines" source
...
AS SELECT flatten_ae.source,
   ...
   flatten_ae."centreCouts_codeDepartement"
   FROM flatten_ae
UNION ALL
 SELECT flatten_ademe.source,
   ...
   flatten_ademe."centreCouts_codeDepartement"
   FROM flatten_ademe
UNION ALL
 SELECT flatten_orphan_cp.source,
   ...
   flatten_orphan_cp."centreCouts_codeDepartement"
