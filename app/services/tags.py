...
def select_ae_have_tags(tag_id: int):
    """
...
def sanitize_tag_fullname(tag: str):
    """
    Convertit les pretty name de tag en fullname comme décrit dans
    :meth:`app.models.tags.Tags.fullname`
    """
    if not ":" in tag:
        return tag + ":"
    return tag
