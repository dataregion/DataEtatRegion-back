...
class France2030(db.Model):
    ...
    categorie_juridique = Column(String, nullable=True, primary_key=True)
    code_commune = Column(String, nullable=True, primary_key=True)
    nom_beneficiaire = Column(String, nullable=True, primary_key=True)
    adresse = Column(String, nullable=True, primary_key=True)
    code_qpv = Column(String, nullable=True, primary_key=True)
    label_commune = Column(String, nullable=True, primary_key=True)
    code_crte = Column(String, nullable=True, primary_key=True)
    label_crte = Column(String, nullable=True, primary_key=True)
    code_region = Column(String, nullable=True, primary_key=True)
    label_region = Column(String, nullable=True, primary_key=True)
    code_epci = Column(String, nullable=True, primary_key=True)
    label_epci = Column(String, nullable=True, primary_key=True)
    code_departement = Column(String, nullable=True, primary_key=True)
    label_departement = Column(String, nullable=True, primary_key=True)
    is_pvd = Column(Boolean, nullable=True, primary_key=True)
    date_pvd = Column(Date, nullable=True, primary_key=True)
    is_acv = Column(Boolean, nullable=True, primary_key=True)
    date_acv = Column(Date, nullable=True, primary_key=True)
    code_arrondissement = Column(String, nullable=True, primary_key=True)
    label_arrondissement = Column(String, nullable=True, primary_key=True)
    categorie_typologie = Column(String, nullable=True, primary_key=True)
    code_iso_region = Column(String, nullable=True, primary_key=True)
